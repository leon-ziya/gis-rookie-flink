 ...
 * 异步的Http请求对象， 可设置代理
 * @author leon
 * @ClassName HttpClientAsyncUtil.java
 * @createTime 2020年10月16日 17:50:00
 */
public class HttpClientAsyncUtil {
    ...
    private static int maxPerRoute = 1000;      // 每个主机的并发最多只有1500
    ...
    public CloseableHttpAsyncClient createAsyncClient(boolean proxy)
        ...
        PoolingNHttpClientConnectionManager conMgr =
